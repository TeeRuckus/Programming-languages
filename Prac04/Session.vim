...
setlocal wrap
setlocal wrapmargin=0
let s:l = 13 - ((12 * winheight(0) + 43) / 86)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
13
...
exe 'vert 3resize ' . ((&columns * 120 + 181) / 363)
tabnext
edit ~/Documents/Programming\ Languages/Prac07/Makefile
set splitbelow splitright
wincmd t
set winminheight=0
set winheight=1
...
tabnext 1
set stal=1
badd +0 ~/Documents/Programming\ Languages/Prac04/rules.l
badd +0 ~/Documents/Programming\ Languages/Prac07/Makefile
badd +0 ~/Documents/Programming\ Languages/Prac04/Makefile
